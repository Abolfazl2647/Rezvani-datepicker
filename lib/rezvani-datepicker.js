        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                this.props.calender.all_days.map(function (item, index) {
                    ...
                    today = item.date === _this5.props.calender.todayString;
                    ...
                    return _react2.default.createElement(
                        ...
                        { key: index + 'days',
                            ...
                            className: (beforeDate ? ' disabled ' : '') + (afterDate ? ' disabled ' : '') + (afterToday ? ' disabled ' : '') + (beforeToday ? ' disabled ' : '') + (selected ? ' selectedDay ' : '') + (today ? ' today ' : '') + (weekend ? ' weekend ' : '') + item.info + " rn-days ",
                            'data-date': item.date },
                        item.day
                    );
                })
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                this.props.calender.all_days.map(function (item, index) {
                    ...
                    today = item.date === _this8.props.calender.todayString;
                    return _react2.default.createElement(
                        'div',
                        { key: index + 'days',
                            onClick: function onClick() {
                            ...
                            className: _this8.props.exteraClassForDays + " " + (beforeDate ? ' disabled ' : '') + (afterDate ? ' disabled ' : '') + (afterToday ? ' disabled ' : '') + (beforeToday ? ' disabled ' : '') + (hover ? ' range-select ' : '') + (endDate ? ' endDate ' : '') + (startDate ? ' startDate ' : '') + (today ? ' today ' : '') + (weekend ? ' weekend ' : '') + item.info + " rn-days ",
                            'data-date': item.date },
                        item.day
                    );
                })
